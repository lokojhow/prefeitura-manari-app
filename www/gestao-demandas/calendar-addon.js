(()=>{
  ...
  if(!document.querySelector('script[data-calendar-reminders]')){const r=document.createElement('script');r.src='calendar-reminders-addon.js?v=3';r.dataset.calendarReminders='1';document.body.appendChild(r)}
